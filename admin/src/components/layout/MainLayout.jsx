    ...
    return (
        <div className="flex min-h-screen bg-gray-50">
            ...
            <aside
                ...
                style={{
                    background: 'linear-gradient(160deg, #FDFBF9 0%, #E8D8C4 40%, #D8C7B3 80%, #C7B7A3 100%)',
                    borderRight: '1px solid rgba(109,41,50,0.12)',
                    boxShadow: '4px 0 24px rgba(109,41,50,0.08)'
                }}
            >
                {/* Logo */}
                <div className="flex items-center gap-3 px-5 py-4" style={{ borderBottom: '1px solid rgba(109,41,50,0.12)' }}>
                    <div className="bg-white p-1 rounded-xl shadow-[0_4px_16px_rgba(109,41,50,0.15)] ring-1 ring-[#C7B7A3] flex-shrink-0">
                        <img
                            src={logoImage}
                            alt="Logo"
                    ...
                    <div className="hidden lg:block">
                        <h1 className="text-base font-black tracking-wider leading-tight" style={{ color: '#561C24', fontFamily: 'Algerian, serif' }}>
                            V.M.S<br />GARMENTS
                        </h1>
                    </div>
                </div>
                    ...
                    {navigationSections.map((section, sectionIndex) => (
                        <div key={sectionIndex} className={sectionIndex > 0 ? 'mt-4' : ''}>
                            <button
                                ...
                                style={{ color: '#6D2932', opacity: 0.8 }}
                            >
                                {section.title}
                                <ChevronRight
                                    size={14}
                                        ...
                                        {section.items.map((item) => (
                                            <NavLink
                                                ...
                                                className={({ isActive }) => `
                                                    ...
                                                    ${isActive
                                                        ? 'shadow-[0_2px_12px_rgba(109,41,50,0.2)]'
                                                        : 'hover:bg-[#E8D8C4]/40'}
                                                `}
                                                style={({ isActive }) => isActive ? {
                                                    background: 'linear-gradient(135deg, rgba(232,216,196,0.6) 0%, rgba(199,183,163,0.4) 100%)',
                                                    border: '1px solid rgba(109,41,50,0.2)'
                                                } : {}}
                                                onClick={() => setSidebarOpen(false)}
                                            >
                                                {({ isActive }) => (
                                                    <>
                                                        <item.icon
                                                            ...
                                                            style={{ color: isActive ? '#561C24' : '#6D2932' }}
                                                            strokeWidth={2}
                                                        />
                                                        <span className="text-sm font-semibold" style={{ color: isActive ? '#561C24' : '#475569' }}>{item.name}</span>
                                                    </>
                                                )}
                                            </NavLink>
                                        ))}
