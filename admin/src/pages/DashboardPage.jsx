...
const DashboardPage = () => {
    ...
    const colorClasses = {
        sage: 'bg-[#E8D8C4] text-[#6D2932]',
        blue: 'bg-[#C7B7A3] text-[#561C24]',
        green: 'bg-[#FDFBF9] text-[#6D2932] border border-[#C7B7A3]',
        orange: 'bg-[#E8D8C4] text-[#561C24]'
    };
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <Link
                    to="/dashboard/items"
                    className="flex items-center gap-4 p-4 bg-white rounded-2xl border border-[#C7B7A3]/40 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group"
                >
                    <div className="w-12 h-12 bg-[#E8D8C4] rounded-xl flex items-center justify-center text-[#6D2932] group-hover:bg-[#6D2932] group-hover:text-[#FDFBF9] transition-colors">
                        <ShoppingBag size={24} />
                    </div>
                    <div>
                ...
                <Link
                    ...
                    className="flex items-center gap-4 p-4 bg-white rounded-2xl border border-[#C7B7A3]/40 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group"
                >
                    <div className="w-12 h-12 bg-[#C7B7A3]/50 rounded-xl flex items-center justify-center text-[#561C24] group-hover:bg-[#561C24] group-hover:text-[#FDFBF9] transition-colors">
                        <IndianRupee size={24} />
                    </div>
                    <div>
                ...
                <Link
                    ...
                    className="flex items-center gap-4 p-4 bg-white rounded-2xl border border-[#C7B7A3]/40 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group"
                >
                    <div className="w-12 h-12 bg-[#E8D8C4] rounded-xl flex items-center justify-center text-[#561C24] group-hover:bg-[#561C24] group-hover:text-[#E8D8C4] transition-colors">
                        <TrendingUp size={24} />
                    </div>
                    <div>
                ...
                <Link
                    ...
                    className="flex items-center gap-4 p-4 bg-white rounded-2xl border border-[#C7B7A3]/40 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group"
                >
                    <div className="w-12 h-12 bg-[#FDFBF9] border border-[#C7B7A3] rounded-xl flex items-center justify-center text-[#6D2932] group-hover:bg-[#6D2932] group-hover:text-[#FDFBF9] transition-colors">
                        <Users size={24} />
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                {statsCards.map((stat, index) => (
                    <div key={index} className="relative bg-white rounded-2xl p-5 border border-[#C7B7A3]/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden group">
                        {/* Gradient Accent Bar */}
                        <div className={`absolute top-0 left-0 w-full h-1 ${stat.color === 'sage' ? 'bg-[#6D2932]' :
                            stat.color === 'blue' ? 'bg-[#C7B7A3]' :
                                stat.color === 'green' ? 'bg-[#561C24]' :
                                    'bg-[#E8D8C4]'
                            }`}></div>
                        ...
                        <div className="flex items-start justify-between">
                            ...
                            <div className={`p-3 rounded-xl ${stat.color === 'sage' ? 'bg-[#E8D8C4] text-[#6D2932]' :
                                stat.color === 'blue' ? 'bg-[#C7B7A3]/50 text-[#561C24]' :
                                    stat.color === 'green' ? 'bg-[#FDFBF9] border border-[#C7B7A3] text-[#6D2932]' :
                                        'bg-[#E8D8C4] text-[#561C24]'
                        ...
                        <AreaChart data={revenueData}>
                            <defs>
                                <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
                                    <stop offset="5%" stopColor="#6D2932" stopOpacity={0.3} />
                                    <stop offset="95%" stopColor="#6D2932" stopOpacity={0} />
                                </linearGradient>
                            </defs>
