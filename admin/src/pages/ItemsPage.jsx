...
const ItemsPage = () => {
    ...
    // Full product form data (with image and featured)
    ...
    const generateAIImage = () => {
        ...
        const keywords = formData.name.toLowerCase().replace(/\s+/g, ',');
        const imageUrl = `https://source.unsplash.com/800x800/?garments,clothing,${keywords}`;
        setFormData(prev => ({ ...prev, image: imageUrl }));
        toast.info('Placeholder image URL generated (Unsplash)');
    };
                                        ...
                                        <td>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    {item.featured && (
                                                        <span className="text-[10px] bg-yellow-100 text-yellow-700 font-bold px-1 py-0.5 rounded">FEATURED</span>
                                                    )}
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="p-6 overflow-y-auto max-h-[70vh] space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-end gap-4 p-2 bg-yellow-50 rounded-lg border border-yellow-100">
                                    <label className="flex items-center gap-2 cursor-pointer select-none">
                                        ...
                                        />
                                        <span className="text-sm font-bold text-yellow-800 uppercase tracking-tight">Featured in Shop</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 space-y-3">
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className="px-4 py-2 bg-blue-100 text-blue-700 font-bold rounded-lg text-xs hover:bg-blue-200 transition shrink-0"
                                        >
                                            AUTO-FILL
                                        </button>
                                    </div>
                                ...
                                {formData.image && (
                                    <div className="mt-2 text-center">
                                        <img src={formData.image} alt="Preview" className="h-24 mx-auto rounded-lg shadow-sm border border-gray-200" />
                                        <p className="text-[10px] text-gray-400 mt-1 uppercase font-bold tracking-widest">Image Preview</p>
                                    </div>
                                )}
                            </div>
